...
Text::Galician - Galician Stemmer

=head1 SYNOPSIS

  use Text::Galician;

  Text::Galician::stem(\@words);
...
See L<Text::Portuguese> for a sketch of the stemming algorithm, and L<http://bvg.udc.es/recursos_lingua/stemming.html> for stemming rules.
